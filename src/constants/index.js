...
export const USER_BASE_URL = 'http://localhost:8081/user';
...
export const GITHUB_AUTH_URL   =  AUTH_BASE_URL + '/oauth2/authorize/github?redirect_uri=' + OAUTH2_REDIRECT_URI;
